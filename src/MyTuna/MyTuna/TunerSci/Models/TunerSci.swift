...
protocol TunerSciDelegate: class {
...
class TunerSci {
    weak var delegate: TunerSciDelegate?
    private let settings = Settings.shared()
    static let sharedInstance = TunerSci()
...
//    }
    ...
    var strings: [MTPitchedNote] { return settings.tuning.strings }
    
    var sortedStrings: [MTPitchedNote] {
    ...
    var targetString: MTPitchedNote?
