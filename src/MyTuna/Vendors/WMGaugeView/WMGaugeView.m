...
- (void)drawScale:(CGContextRef)context
{
    ...
    for (int i = 0; i < totalTicks; i++)
    {
        ...
        if ((fabsf(mod - 0) < 0.000001) || (fabsf(mod - div) < 0.000001))
        {
            ...
            // CGRect centerPitchLabelRect = CGRectZero;
            // self.centerPitchLabel = [[UILabel alloc] initWithFrame:centerPitchLabelRect];
