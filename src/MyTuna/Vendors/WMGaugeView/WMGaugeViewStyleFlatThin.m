...
#define kNeedleScrewRadius  0.012

#define kCenterX            0.5
#define kCenterY            0.5

//#define kNeedleColor        CGRGB(255, 104, 97)
#define kNeedleColor        CGRGB(250, 250, 250)
#define kNeedleScrewColor   CGRGB(68, 68, 68)
...
{
#define EXTERNAL_RING_RADIUS    0.12
#define INTERNAL_RING_RADIUS    EXTERNAL_RING_RADIUS * 0.80
